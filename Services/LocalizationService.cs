...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
    {
        ...
        ["zh-CN"] = new()
        {
            ...
            ["SettingsUpdateSection"] = "🔗 项目更新地址 (Update URL):",
            ["BtnOpenUpdateUrl"] = "🌐 访问 GitHub",
            ["BtnSaveApply"] = "保存并应用",
            ["BtnCancel"] = "取消",
        ...
        ["en-US"] = new()
        {
            ...
            ["SettingsUpdateSection"] = "🔗 Project & Update URL (GitHub):",
            ["BtnOpenUpdateUrl"] = "🌐 Visit GitHub",
        ...
        ["zh-TW"] = new()
        {
            ...
            ["SettingsUpdateSection"] = "🔗 專案與更新網址 (Update URL):",
            ["BtnOpenUpdateUrl"] = "🌐 前往 GitHub",
            ["BtnSaveApply"] = "儲存並套用",
            ["BtnCancel"] = "取消",
